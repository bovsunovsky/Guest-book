...
{
    $query = "INSERT INTO guesttab SET name='$name', text='$text'";
    return $query;
}
...
$query = "SELECT COUNT(*) as count FROM guesttab";
...
if ($count > 3) {
    ...
    $query = "SELECT * FROM guesttab ORDER BY date DESC LIMIT $startPosition, 3";
} else {
    $query = "SELECT * FROM guesttab ORDER BY date DESC";
}
